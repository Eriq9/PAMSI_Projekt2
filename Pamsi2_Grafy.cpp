...
void wypisz_dane(int wierzcholki, int il_krawedz, fstream& strumien) ///funkcja wypisujaca wygenerowane grafy do pliku
{
    ...
    strumien.open("dane_do_pliku.txt", ios_base::app);           ///otwieramy strumien danych zapisu do pliku
...
void generuj_dane(fstream& strumien)
{
    ...
    strumien.open("dane_do_pliku.txt", ios_base::out);       ///****|-> otwieramy strumien do zapisu danych do pliku dane.txt
...
void znajdz_droge(ifstream& wejscie)
{
    ...
    wyjscie.open("pomiary.txt", ios_base::app);  ///otwieramy strumien wyjsciowy do pliku pomiar.txt
...
void pomiar(ifstream& strumien)
{
    ...
    strumien.open("dane_do_pliku.txt", ios_base::in); ///otwarcie strumienia do pliku z danymi wejsciowymi dla grafow
...
int main()
{
    ...
    do
    {
        ...
        switch( wybor )
        {
            case 1: generuj_dane(dane);///generuje dane i zapisuje je do pliku, wylaczone aby nie usunac 1.5GB danych
